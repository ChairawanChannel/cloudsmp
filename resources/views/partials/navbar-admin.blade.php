...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="/atable-feedback" class="nav-link"><i class="fa-solid fa-database"></i> Table Feedback</a>
        <a href="atable-vote" class="nav-link"><i class="fa-solid fa-table"></i> Table Vote</a>
        <a href="atable-transactions" class="nav-link"><i class="fa-solid fa-bag-shopping"></i> Table
            Transactions</a>
    </div>
