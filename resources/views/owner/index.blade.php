...
<body>
    ...
    <nav class="navbar">
        ...
        <!-- Navigation Links -->
        <div class="nav-links">
            <a href="/owner" class="nav-link"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
            <a href="owner/table-feedback" class="nav-link"><i class="fa-solid fa-database"></i> Table Feedback</a>
            <a href="owner/table-vote" class="nav-link"><i class="fa-solid fa-table"></i> Table Vote</a><a
                href="owner/table-transactions" class="nav-link"><i class="fa-solid fa-bag-shopping"></i> Table
                Transactions</a>
            <a href="owner/print" class="nav-link"><i class="fa-solid fa-print"></i> Print</a>
        </div>
